# job-log-management Specification

## Purpose
Define canonical job-scoped artifacts, live log capture, progress schemas, and retention rules for crawler and embedding jobs.
