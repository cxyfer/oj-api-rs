# http-mcp Specification

## Purpose
Define the native HTTP MCP surface exposed by `oj-api-rs` at `/mcp`, including transport mode, authentication, tool inventory, and Markdown output contracts.
